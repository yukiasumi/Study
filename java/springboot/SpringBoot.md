...
![image-20210115152427829](C:\Users\hakuou\Documents\program\Program\java\springboot\images\image-20210115152427829.png)	
...
![image-20210115155556662](C:\Users\hakuou\Documents\program\Program\java\springboot\images\image-20210115155556662.png)	
...
```properties
#此参数指定使用配置文件，此时yml文件优先级高于properties
#若yml配置文件中无属性，则使用properties中的
...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        System.out.println("拦截成功：LoginInterceptor的preHandle");
        return false;
    }
}
```
...
![image-20210119150418295](C:\Users\hakuou\Documents\program\Program\java\springboot\images\image-20210119150418295.png)	
